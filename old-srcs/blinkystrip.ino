...
#define wifi_ssid "LoungeNet" //enter your WIFI SSID
...
#define DATA_PIN    D7 //on the NodeMCU 1.0, FastLED will default to the D5 pin after throwing an error during compiling. Leave as is. 
...
#define lwtpub "bruh/mqttstrip/LWT"

#define setcolorsub "bruh/mqttstrip/cmnd/COLOR"
#define setpowersub "bruh/mqttstrip/cmnd/POWER"
#define seteffectsub "bruh/mqttstrip/cmnd/EFFECT"
#define setbrightness "bruh/mqttstrip/cmnd/BRIGHTNESS"
#define setanimationspeed "bruh/mqttstrip/cmnd/ANIMATIONSPEED"

#define colorpub "bruh/mqttstrip/COLOR"
#define powerpub "bruh/mqttstrip/POWER"
#define effectpub "bruh/mqttstrip/EFFECT"
#define brightnesspub "bruh/mqttstrip/BRIGHTNESS"
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  if (String(topic) == setpowersub) {
    ...
    if (setPower == "OFF") {
      client.publish(powerpub, "OFF");
    }

    if (setPower == "ON") {
      client.publish(powerpub, "ON");
    }
  } else if (String(topic) == seteffectsub) {
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    // Attempt to connect
    if (client.connect(SENSORNAME, mqtt_user, mqtt_password, lwtpub, 0, true, "offline")) {
      ...
      client.publish(powerpub, "OFF");
      client.publish(lwtpub, "online", true);
    } else {
